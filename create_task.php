...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($title)) {
        // Aufgabe erstellen, Fälligkeitsdatum mit übergeben
        $message = create_task($conn, $user_id, $title, $description, $due_date);
    } else {
...
<body>
    ...
    <div class="container">
        ...
        <form method="POST" action="">
            ...
            <textarea id="description" name="description" rows="5" placeholder="Beschreibe die Aufgabe..."></textarea>
